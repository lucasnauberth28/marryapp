...
function SelectTrigger({
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full items-center justify-between gap-2 rounded-xl border border-stone-200 bg-white px-3.5 py-2 text-sm text-stone-800 transition-colors outline-none select-none focus-visible:border-[#8C6D45] focus-visible:ring-2 focus-visible:ring-[#8C6D45]/20 disabled:cursor-not-allowed disabled:opacity-50 data-placeholder:text-stone-400 data-[size=default]:h-10 data-[size=sm]:h-8 data-[size=lg]:h-12 shadow-xs cursor-pointer",
        className
      )}
      {...props}
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon className="pointer-events-none size-4 text-stone-400 shrink-0" />
...
function SelectItem({
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-pointer items-center rounded-xl py-2 pr-8 pl-2.5 text-xs sm:text-sm font-medium text-stone-700 outline-none select-none transition-colors hover:bg-[#FAF4ED] hover:text-[#8C6D45] focus:bg-[#FAF4ED] focus:text-[#8C6D45] data-disabled:pointer-events-none data-disabled:opacity-50",
        className
      )}
      {...props}
    >
      <span className="pointer-events-none absolute right-2 flex size-4 items-center justify-center text-[#8C6D45]">
