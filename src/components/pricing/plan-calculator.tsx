...
export function PlanCalculator() {
  ...
  return (
    <div className="space-y-8 font-sans">
      {/* ========================================================================= */}
      {/* 1. MODO PADRÃO: 3 PACOTES FIXOS (BÁSICO, CLASSIC, VIP) */}
      {/* ========================================================================= */}
      {!showCustomBuilder ? (
        <div className="space-y-8">
          ...
          {/* Link Discreto para Montar Plano Personalizado */}
          <div className="text-center pt-4">
            <button
              onClick={() => setShowCustomBuilder(true)}
              className="inline-flex items-center gap-2 text-xs font-bold text-[#8C6D45] hover:text-[#785c39] hover:underline underline-offset-4 transition-all cursor-pointer p-2"
            >
        ...
        /* ========================================================================= */
        /* 2. MODO EXPANDIDO: MONTE SEU PLANO PERSONALIZADO */
        /* ========================================================================= */
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <button
              onClick={() => setShowCustomBuilder(false)}
              className="inline-flex items-center gap-2 text-xs font-bold text-stone-600 hover:text-stone-900 bg-stone-100 hover:bg-stone-200 px-4 py-2 rounded-full transition-colors cursor-pointer"
            >
              <ArrowLeft className="w-3.5 h-3.5" />
              <span>Voltar aos Pacotes Fixos</span>
            </button>

            <span className="text-xs font-bold text-[#8C6D45]">
              🎛️ Montador de Plano Adaptado
            </span>
          </div>
