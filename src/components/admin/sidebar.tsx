...
import { Users, LayoutDashboard, Wallet, Gift, CheckSquare, Plane } from "lucide-react"
...
const navItems = [
  ...
  { name: "Pendências", href: "/tarefas", icon: CheckSquare },
    ...
    <aside className="w-64 bg-white border-r border-zinc-200 flex flex-col hidden md:flex">
      <div className="h-16 flex items-center px-6 border-b border-zinc-200">
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-bold text-xl text-zinc-900 tracking-tight">MarryApp</h1>
        </div>
      </div>
